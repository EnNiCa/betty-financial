...
@app.route('/api/analizar-pilares', methods=['POST'])
def upload_pilares():
    ...
    if file and allowed_file(file.filename):
        ...
        try:
            ...
            # Priorizar Hoja4 (tiene todas las columnas incluyendo evolución de caja y baja)
            posibles_hojas = ['Hoja4', 'Hoja2', 'Transacciones', 'Datos', 'Sheet2']
